...
/**
 * 
 * @author Joseph Wolf Programming Assignment 9 - FractalPanel class
 * @since 18 Nov 2014
 * 
...
public class FractalPanel extends JPanel {
	...
	public void paintComponent( Graphics g ) {
		...
		for(int index = 0; index<=lines.size()-1; index++ ){
			drawKochLine(g2,this.level,(KochLine)(lines.get(index))) ;
		}
	...
	public void drawKochLine( Graphics2D g2, int level, KochLine line ) {
		...
		//Method draws lines and is finished. 
		if (level == 0){
		...
		// Method recurses and draws more lines.
		else{
